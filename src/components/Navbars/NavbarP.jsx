    ...
    return (
        ...
        >
            ...
            >
                ...
                <a href={`/profile`}><span className="underline decoration-red-500 cursor-pointer transition duration-200 ease-in-out text-black font-light font-poppins">PROFILE</span></a>
            </div>
        </div>
    );
};
